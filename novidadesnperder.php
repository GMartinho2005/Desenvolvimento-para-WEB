...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row">
                ...
                <?php 
                // --- 3. O LOOP MÁGICO (COM O NOVO HTML) ---
                // Loop atualizado para $livros_avaliados
                foreach ($livros_avaliados as $livro): 
                ?>
                
                <!-- Início de um item de livro (Metade da largura em desktop) -->
                <div class="col-lg-6 mb-4">
                    <div class="row g-3 g-md-4">
                        ...
                        <div class="col-8">
                            ...
                            <!-- Subtítulo (só aparece se existir) -->
                            ...
                            <!-- Descrição (Aparece em ecrãs médios ou maiores) -->
                            <p class="text-muted d-none d-md-block mt-2" style="font-size: 0.9rem;">
                                <?php echo htmlspecialchars($livro['description']); ?>
                            </p>

                            <!-- Botão -->
                            <a href="<?php echo htmlspecialchars($livro['link']); ?>" class="btn btn-outline-dark btn-sm mt-1">
                                Ver mais
                            </a>
                        </div>
                    </div>
                </div>
                <!-- Fim de um item de livro -->
