...
// --- LÓGICA DE MENSAGENS (Para mostrar alertas) ---
// Verifica se há uma mensagem de sucesso (vinda do registo)
if (isset($_SESSION['success_message'])) {
    $success_message = $_SESSION['success_message'];
    unset($_SESSION['success_message']); // Limpa para não mostrar de novo
}
// Verifica se há uma mensagem de erro (vinda do processamento de login)
if (isset($_SESSION['login_error'])) {
    $error_message = $_SESSION['login_error'];
    unset($_SESSION['login_error']); // Limpa para não mostrar de novo
}
    ...
    <div class="login-wrapper">
        ...
        <div class="card login-card shadow-lg">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <?php
                // --- Bloco PHP para mostrar mensagens de SUCESSO (do registo) ---
                if (isset($success_message)) {
                    echo '<div class="alert alert-success" role="alert">' . htmlspecialchars($success_message) . '</div>';
                }
                
                // --- Bloco PHP para mostrar mensagens de ERRO (do login) ---
