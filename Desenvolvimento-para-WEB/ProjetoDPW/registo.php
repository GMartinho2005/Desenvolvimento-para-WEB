...
// --- 2. LÓGICA DE REGISTO (SÓ EXECUTA SE O FORMULÁRIO FOR SUBMETIDO) ---
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register_submit'])) {

    // --- Configuração da Base de Dados (Padrão do Laragon) ---
    $db_host = '127.0.0.1';
    $db_name = 'web2';
    $db_user = 'root';
    $db_pass = '';
...
// --- LÓGICA DE MENSAGENS (Para mostrar erros de registo) ---
if (isset($_SESSION['register_error'])) {
    $error_message = $_SESSION['register_error'];
    unset($_SESSION['register_error']); // Limpa para não mostrar de novo
}
...
<body style="background-image: url('../imgs/a-warm-cinematic-photograph-of-weathered_KZWDuYg5SuOiq4z52l4tiQ_kiSEf0_HQTOWaHDJq9L7Vg.jpeg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    ...
    <div class="login-wrapper">
        <div class="card login-card shadow-lg" style="max-width: 500px;"> <!-- Cartão mais estreito -->
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <?php
                // --- Bloco PHP para mostrar erros de REGISTO ---
                if (isset($error_message)) {
                    echo '<div class="alert alert-danger" role="alert">' . htmlspecialchars($error_message) . '</div>';
                }
                ?>

                <!-- O formulário aponta para ELE PRÓPRIO (registo.php) -->
