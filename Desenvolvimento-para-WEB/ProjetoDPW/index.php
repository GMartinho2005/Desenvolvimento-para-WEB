...
<div class="hero-banner position-relative">
  ...
  <div class="d-flex justify-content-between align-items-center mx-4">
    ...
    <a class="subtitulo text-decoration-none text-dark fw-semibold me-5" href="maisvisitados.php">Ver +</a>
  </div>
  ...
  <div class="d-flex justify-content-between align-items-center mx-4">
    ...
    <a class="subtitulo text-decoration-none text-dark fw-semibold me-5" href="novidadesnperder.php">Ver +</a>
  </div>
...
<div class="colecao-mais-visitados mt-5">
  <div class="d-flex justify-content-between align-items-center mx-4">
    ...
    <a class="subtitulo text-decoration-none text-dark fw-semibold me-5" href="halloween.php">Ver +</a>
  </div>
...
<div class="colecao-mais-visitados mt-5">
  <div class="d-flex justify-content-between align-items-center mx-4">
    ...
    <a class="subtitulo text-decoration-none text-dark fw-semibold me-5" href="maisnovos.php">Ver +</a>
  </div>
